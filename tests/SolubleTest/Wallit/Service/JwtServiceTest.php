...
class JwtServiceTest extends TestCase
{
    ...
    public function testParseTokenStringHmac()
    {
        ...
        $token1 = $jwtService->parseTokenString($jwt_io);
        ...
        $token2 = $jwtService->parseTokenString($token256);
    ...
    public function testParseTokenStringThrowsInvalidTokenException()
    {
        ...
        $jwtService->parseTokenString($tokenString);
    }
    ...
    public function testVerifyTokenString()
    {
        ...
        $this->assertTrue($jwtService->verifyTokenString($token384->__toString()));
    }
    ...
    public function testVerifyTokenStringThrowsInvalidTokenException()
    {
        ...
        $tokenString = 'eyJhbGciOiJIUzI1NiIsInR5cCI';
        $jwtService->verifyTokenString($tokenString);
    }
